        ...
        <tbody>
          <tr>
            <td><b>Estimado(a)</b><br>
              <p>Ha recibo un nuevo correo mediante PLATAFORMA DE CERTIFICADOS.</p>
              <hr>
              <p><b>Nombre:</b> {{$send_alumno->nombres}} {{$send_alumno->apellidos}}</p>
              <p><b>Correo:</b> {{$send_alumno->email}}</p>
              <p><b>Celular:</b> +56 9 {{$send_alumno->celular}}</p>
              <p><b>Motivo:</b> {{$send_motivo}}</p>
              <p align="justify"><b>Mensaje: </b> {{$send_mensaje}}</p>
              
              <a href="mailto:{{$send_alumno->email}}"  style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #00c0c8; border-radius: 60px; text-decoration:none;"> Responder Email </a>
