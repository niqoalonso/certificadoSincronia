        ...
        <tbody>
          <tr>
            <td><b>Estimado(a)</b><br>
              <p>Ha recibo un nuevo correo DE SOLICITUD DE CERTIFICADOS.</p>
              <hr>
              <p><b>Nombre:</b> {{$send_nombre}}</p>
              <p><b>Correo:</b> {{$send_email}}</p>
              <p><b>Empresa:</b> {{$send_empresa}}</p>
              <p><b>Certificado:</b> {{$send_codigo->codigo_cert}}</p>
                <p><b>Alumno:</b> {{$send_codigo->Alumno->nombres}} {{$send_codigo->Alumno->apellidos}}</p>
              @if(!empty($send_mensaje))
