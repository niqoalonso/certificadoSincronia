...
<main id="main">
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Certificados</h2>
          <p style="color: #444444;">Te permitimos consultar por el estado y vigencia de nuestros certificados emitidos, asi tambien podras solicitar los certificados de manera digital si eres una institución o empresa.</p>
        </div>

        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue col-12">
              <div class="icon">
              ...
              <h4><a href="">RUT - DNI</a></h4>
              <form id="FormRut" method="POST">
                  @csrf
                <input type="text" class="form-control" id="input_dni" onkeyup="checkRut(this)" name="rut" placeholder="12345678-9" required>
                <br>
                <button type="submit" class="btn btn-success btn-block"><i class="bx bx-search" style="color: #fff"></i> Verificar</button>
               </form>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange col-12">
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
              ...
              <form id="FormNombre" method="POST">
                  @csrf
                <h4><a href="">NOMBRE COMPLETO</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-red col-12">
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
              ...
              <form id="FormCodigo" method="POST">
                @csrf
                <h4><a href="">CODIGO IDENTIFICADOR</a></h4>
    ...
    <section id="resume" class="resume">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row body-certificado" id="div1">           
...
@section('js')
    <script src="{{asset('frontend/js/valida-rut.js')}}" type="text/javascript"></script>
